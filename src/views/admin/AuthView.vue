<template>
  <div class="flex h-max">
    ...
    <div class="w-1/2 bg-[#ffffff] flex-grow text-black flex flex-col p-8">
      ...
      <div class="register-block">
        ...
        <dialog ref="registerDialog">
          <form class="flex flex-wrap">
            <input type="text" class="m-2 p-2 border-b border-gray-500 bg-transparent text-gray-300 focus:outline-none flex-1" placeholder="Name" v-model="name" /> 
            <input type="text" class="m-2 p-2 border-b border-gray-500 bg-transparent text-gray-300 focus:outline-none flex-1" placeholder="Email" v-model="email" /> 
            <input type="password" class="m-2 p-2 border-b border-gray-500 bg-transparent text-gray-300 focus:outline-none flex-1 w-full" placeholder="Password" v-model="password" /> 
